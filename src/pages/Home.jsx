        ...
        <div className='flex items-center justify-between'>
          <div>
            ...
            <div className='ml-4 mt-4'>
              <button className='bg-grey px-8 py-4 mx-5 my-4 text-white text-2xl rounded-full'>
                Sobre mim
              </button>
              <button className='bg-purple px-10 py-4 mx-5 my-4 text-white text-2xl rounded-full'>
                Meus Projetos
              </button>
            </div>
          </div>
      ...
      <section className='bg-gray px-32 pb-8'>
        ...
        <div>
          ...
          <ProjectCard
            ...
            reversed
          >
            Preencha um formulário para criar um baralho do famoso jogo dos anos 90 "Super Trunfo".
          </ProjectCard>
        </div>
      </section>
    </main>
